...
class ProjectLogin extends Template implements ActionListener,Runnable
{
  JButton SUBMIT;
  ...
  public void actionPerformed(ActionEvent ae)
  {
    ...
    if(ae.getSource()==SUBMIT)
    {
      ...
      if(value1.equals("ProjectAdmin") && value2.equals("ProjectAdmin"))
      {
      ...
      else
      {
        ...
        if(attemp ==0)
        {
          JOptionPane.showMessageDialog(this,"number of attent finish","packer unpacker",JOptionPane.ERROR_MESSAGE);
          this.dispose();
          System.exit(0);

        }
        JOptionPane.showMessageDialog(this, "incorrect login and password","error",JOptionPane.ERROR_MESSAGE);
      }
    }
  }
